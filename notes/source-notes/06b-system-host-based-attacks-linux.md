...
1. What is the password of user “admin” required to access share “admin”?
...
1. Which share is read only? Use smbmap with credentials obtained in question 2.
...
1. Is share “jane” browseable? Use credentials obtained from the 1st question.
...
1. Fetch the flag from share “admin”
...
1. List the named pipes available over SMB on the samba server? Use pipe_auditor metasploit module with credentials obtained from question 2.
...
1. List SID of Unix users shawn, jane, nancy and admin respectively by performing RID cycling using enum4Linux with credentials obtained in question 2.
