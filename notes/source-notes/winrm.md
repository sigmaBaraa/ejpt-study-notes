...
Tool/Topic: Hydra, Metasploit, WinRM

# WinRM

**WinRM (Windows Remote Management)Description**: Protocol for remote command execution on Windows via HTTP(S), often used by admins and attackers alike.
