...
Tool/Topic: Hydra, Metasploit, Nmap, SMB

# SMB - SAMBA

**SMB (Server Message Block)Description**: Protocol for file and printer sharing across a network, mostly used by Windows systems
...
**SambaDescription**: Open-source implementation of SMB protocol for Linux/Unix systems, allowing file/printer sharing with Windows networks
