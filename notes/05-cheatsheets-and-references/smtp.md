...
Tool/Topic: Metasploit, Nmap, SMTP

# SMTP

**SMTP (Simple Mail Transfer Protocol)Description**: SMTP is the standard protocol used to send emails from a client to a mail server or between mail servers. It operates at the application layer of the OSI model.
